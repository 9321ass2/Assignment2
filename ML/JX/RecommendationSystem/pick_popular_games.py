...
if __name__ == "__main__":
    origin_file = pd.read_csv('../DataSet/vgsales-12-4-2019-short.csv').head(3000)
    ...
    mp = pd.read_csv('../DataSet/popular_games_output.csv')
    full = pd.read_csv('../Data_Visualize/KNN.csv')
    game_30(mp, full).to_csv('../DataSet/game_30.csv', index=False)
